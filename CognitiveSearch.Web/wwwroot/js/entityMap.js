        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                data.forEach(function (f) {
                    ...
                    if (f.name == "keyPhrases") {
                        opt.value = "关键词";
                        opt.innerHTML = "关键词";
                    } else if (f.name == "persons") {
                        opt.value = "人物";
                        opt.innerHTML = "人物";
                    } else if (f.name == "locations") {
                        opt.value = "位置";
                        opt.innerHTML = "位置";
                    } else if (f.name == "organizations") {
                        opt.value = "组织";
                        opt.innerHTML = "组织";
                    } 
...
function updateOnClick(d) {
    ...
    window.alert("..."+facet);
    var facetEn = "keyPhrases";
    if (facet == "位置") {
        facetEn = "locations";
    } else if (facet == "组织") {
        facetEn = "organizations";
    } else if (facet == "人物") {
        facetEn = "persons";
    }
    Unload();
    document.getElementById("entity-loading-indicator").style.display = "block";
    GetGraph(d.name, facetEn);
}
