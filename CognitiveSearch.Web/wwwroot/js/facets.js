    ...
    if (selectedFacets && selectedFacets.length > 0) {
        ...
        htmlString += `<div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title">当前筛选条件：</h6>
                            </div>
                            <div>
    ...
    facets.forEach(function (item, index, array) {
        ...
        if (!IsFacetHidden(name)) {
            ...
            facetResultsHTML += `<div class="panel panel-default">
                                <div class="panel-heading">
                                    <h6 class="panel-title" id="${name}-facets">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#${name}" aria-expanded="true">${titleChinese}</a>
                                    </h6>
                                </div>`;
            if (index === 0) {
                facetResultsHTML += `<div id="${name}" class="panel-collapse collapse in show">
                <div class="panel-body">`;
            }
            else {
